...
potFact :: (Num a, HasTrie a) => Int -> [(Int,Polynom a)]
                                                           -> [(Int,Polynom a)]
potFact _ []         = []
...
aggFact :: (Num a, Eq a, HasTrie a) => [(Int,Polynom a)]
                                                            -> [(Int,Polynom a)]
...
obviousFactor :: (Num a, Eq a, HasTrie a) => Polynom a -> [(Int,Polynom a)]
obviousFactor (P[])      = [(1,P[])]
...
appObFact :: (Num a, Eq a, HasTrie a) => [(Int,Polynom a)] -> [(Int,Polynom a)]
